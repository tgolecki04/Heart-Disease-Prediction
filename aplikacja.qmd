...
<script>
  window.API_BASE_URL = "http://127.0.0.1:8000"; // w produkcji zamienić na właściwy adres
</script>

<script>
  const API_BASE = (typeof window !== 'undefined' && window.API_BASE_URL) ? window.API_BASE_URL : "http://127.0.0.1:8000"; // w produkcji zamienić na właściwy adres
  ...
  function showDemoFallback() {
    ...
    html += `<div class="result-confidence">Pewność modelu: <b>${probPercent}%</b></div>`;
    ...
    form.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        if (hasProb) {
          ...
          html += `<div class="result-confidence">Pewność modelu: <b>${pct}%</b></div>`;
        }
