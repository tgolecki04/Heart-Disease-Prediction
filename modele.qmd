...
Uczenie maszynowe można podzielić na **paradygmaty** (np. supervised, unsupervised), które określają sposób, w jaki model uczy się z danych. W ramach tych paradygmatów wyróżniamy **różne typy zadań**, czyli konkretne problemy, które chcemy rozwiązać za pomocą algorytmów ML. Każde zadanie ma specyficzny cel i wymaga odpowiednich metod i algorytmów.

#### Klasyfikacja

-   Cel

    -   Celem klasyfikacji jest przypisanie obserwacji do okreśłonej kategorii.
